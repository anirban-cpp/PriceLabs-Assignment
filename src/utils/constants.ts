...
export const filterData = ["Bedrooms", "Bathrooms", "Sleeps"];
...
export const propertyData: {
  ...
  name: "Astra Hotels - Marathahalli (Spice Garden) | Marathalli Hotel Rooms",
  imgSrc:
    "https://lh3.googleusercontent.com/p/AF1QipOOJAeCgAtX2RzgZf_e6vVklWOvntOfefNusVU=w574-h384-n-k-rw-no-v1",
  match: 76,
  bedroomCount: 3,
  bathroomCount: 1,
  sleepCount: 2,
...
export const getRequestBody = (currentPage: number) => ({
